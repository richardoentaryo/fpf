...
class Encryption
{
    ...
    {
        if(empty($id)){
            throw new Exception("no id to be decoded!");
        }
    ...
    public static function decodeIDWithDash($id)
    {
        if(empty($id)){
            throw new Exception("no id to be decoded!");
        }
    ...
    public static function encodeString($plain)
    {
    ...
    public static function decodeString($ciphertext)
    {
        if(empty($ciphertext)){
